...
public class CodeCademyAllCoursesScene {
    ...
    protected static BorderPane codeCademyAllCoursesLayout() {
        ...
        root.setTop(codeCademyPreviousButtonLayout());
        root.setCenter(codeCademyAllCoursesGridHeader());
        root.setBottom(codeCademyAllCoursesCenterLayout());
        return root;
    }
    ...
    protected static FlowPane codeCademyPreviousButtonLayout(){
        ...
        backButton.addEventHandler(MouseEvent.MOUSE_CLICKED, CodeCademyAllCoursesLogic.eventHandlerBack());
    ...
    protected static GridPane codeCademyAllCoursesGridHeader(){
        ...
        FlowPane backButton = codeCademyPreviousButtonLayout();
        headerGrid.setPadding(new Insets(30,10,50,10));
        headerGrid.setHgap(30);
        headerGrid.add(codeCademyAllCoursesSceneHeader(),1,2);
